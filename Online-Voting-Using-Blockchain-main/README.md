...
## Credits
- 🎓 Built by the UEM College group (project authors).

## License
<img src="https://capsule-render.vercel.app/api?type=waving&color=2e7d32&height=100&section=footer" alt="footer" />
This project is provided for educational purposes. Add a license file if you plan to distribute or deploy.
